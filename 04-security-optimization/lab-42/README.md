## Lab 42 – Monitoring for Common Attack Patterns

### Scenario – Detecting Simple Network Attacks
Recent events have raised concern about basic attacks such as scans, brute force, and simple DoS attempts. Your task is to describe how the existing design can surface these patterns with logging and simple counters.
