## Lab 39 – Logging, Syslog, and Basic Event Triage

### Scenario – Making Security Events Visible
Security incidents have gone unnoticed due to minimal logging. Your task is to design a basic logging plan using syslog, decide what events matter most at CCNA level, and outline how they should be triaged.
