## Advanced Architecture Lab 3 – Dual Stack Campus and Branch Design
...
Here the emphasis is on comparing a classic 3-tier campus with an emerging fabric-based model and deciding where each fits.
