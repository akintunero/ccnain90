## Advanced Virtualization Lab 9 – Multi-Tenant VRF and Secure Tunneling Design
...
In this first virtualization lab you focus on designing the initial VRF layout and core GRE/IPsec tunnel topology that will carry traffic for each business unit between HQ and a small number of remote sites. The goal is to move from a single flat routing table to a clean, multi-tenant underlay that future labs can extend.
