## Advanced Virtualization Lab 12 – Multi-Tenant VRF and Secure Tunneling Design

### Scenario
You are troubleshooting performance and failover issues on existing GRE and IPsec tunnels between HQ and several regional offices. Some tunnels run GRE over IPsec, others use pure IPsec, and failover behaviour is poorly understood. Different applications have different latency and MTU sensitivities.

In this lab you explore how GRE and IPsec choices impact scalability, performance, and redundancy for virtualised paths. Your design must recommend where to use each tunnelling model and how to validate behaviour during failures.
